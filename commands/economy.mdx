---
title: "Economy Commands Reference for XRYPTON Bot"
...
<Note>
Economy commands are powered by XRYPTON's economy cog. Exact command names may reflect your server's configured prefix or slash-command registration. The names listed below are the canonical identifiers — check your server's command list with `/help economy` if any differ.
</Note>
