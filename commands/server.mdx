...
sidebarTitle: "Server"
description: "Reference for XRYPTON's server commands — welcome, leave messages, prefix, autoroles, sticky messages, booster roles, autoresponder, and fake permissions."
---
...
| Command | Usage | Description | Required Permission |
|---|---|---|---|
| `autoresponder` | `autoresponder` | Show the autoresponder help menu. Aliases: `autorespond`, `autoresponse`, `ar`. | Manage Server |
| `autoresponder add` | `autoresponder add <trigger> <response> [--flags]` | Add a new autoresponder. Supports flags: `--not_strict` (partial match), `--self_destruct <seconds>`, `--delete_trigger`, `--reply`. | Manage Server |
| `autoresponder delete` | `autoresponder delete <trigger>` | Remove an autoresponder by its trigger phrase. Alias: `remove`. | Manage Server |
| `autoresponder list` | `autoresponder list` | List all autoresponders configured in the server. | Manage Server |
