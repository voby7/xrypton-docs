---
title: "Play Mini-Games with Friends Using XRYPTON"
...
XRYPTON comes with five interactive mini-games you can play directly inside Discord without leaving the app. Games are controlled entirely through buttons embedded in messages, so there's nothing to install or configure. All games work in **servers, DMs, and private channels**.
